...
| 42 | `src/pages/Desk.jsx:283` | (inline) | `/actions/broker-positions` | `broker_snapshot_cache_json` ✓, dynamic key(s) — per-account/overlay write, via setState(db, …), executes | `/state/positions` | WIRED |
