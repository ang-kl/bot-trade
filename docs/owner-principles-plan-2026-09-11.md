...
### PR-A — Principles into CLAUDE.md; the boot line tells the truth
...
### PR-B — One account model (principles 1, 9)
...
### PR-C — Vetoes minimised (principle 7) — cap unchanged per the owner
...
### PR-E — Every trade has a reason; no UNKNOWN (principle 4)
...
### PR-D — Direction is a stated reason (principle 8)
...
### PR-G — The switch: human AND automatic (principle 2)
...
### PR-F — Nothing fake on the website (principle 6)
...
### PR-H — Blockages cleared (principle 3)
