...
public:
  ...
  void flush();
private:
  struct Job { Identity identity; std::vector<bt::Bar> bars; bt::Options options; long long received = 0, closeAt = 0; jsn::Value source, calendar; std::string key, strategy; };
