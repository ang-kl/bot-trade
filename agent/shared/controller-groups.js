...
export const CONTROLLER_GROUPS = [
  ...
  { key: 'protection', label: 'Execution and position protection', names: ['fast_monitor', 'protection_band', 'order_monitor', 'trade_guards', 'profit_keeper', 'loss_guardian', 'guardian', 'weekend_bank', 'closed_market_sweep', 'momentum_partial', 'momentum_book'] },
