...
export const CONTROLLER_GROUPS = [
  ...
  { key: 'verification', label: 'Verification and account records', names: ['protection_audit', 'log_inspector', 'decision_audit', 'minute_review', 'pnl_reconcile', 'cross_side_equity', 'equity_snapshot', 'cashflow_collection'] },
