...
export const DECLARED_ROUTES = [
  ...
  { path: '/state/workspace-log', accountAware: true, note: 'read by Accounts › Workspace' },
  { path: '/state/workspace-backtests', accountAware: true, note: 'read by Accounts › Workspace' },
