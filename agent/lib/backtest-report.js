...
<p class="meta">Sample gate: conviction ≥ ${num(payload.minConviction ?? 8)}, R:R ≥ ${num(payload.minRr ?? 1.5)}${(payload.minConviction != null && payload.minConviction < 8) || (payload.minRr != null && payload.minRr < 1.5) ? ' — evaluation profile (more permissive than live conviction ≥ 8 / R:R ≥ 1.5, to surface a testable sample)' : ''}</p>
