...
export const ALLOWLIST = Object.freeze({
  ...
  // depositCurrencies moved verbatim from performance-populations.js (V3 WEB-3m), which now has no token.
  'agent/services/deposit-currencies.js': { reason: 'verify each account deposit-currency evidence against its registered broker host (the SELECT and the host pick); one pooling rule for every account', max: { is_live: 2 } },
  // ---- schema and env ------------------------------------------------------
