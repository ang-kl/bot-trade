...
export function sizingBalance(db, accountId = null) {
  ...
  if (id != null) {
    ...
    // The legacy value may exist and may even be right — but nothing here can
    // tell, and "may be right" is not a basis for sizing real money.
  ...
  return {
    ...
    reason: legacy != null
      ? 'no account-scoped balance; the legacy global key has no owner'
