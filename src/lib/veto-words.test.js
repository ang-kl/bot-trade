...
describe('humanVeto', () => {
  it('translates the common machine codes into trader words', () => {
    ...
    expect(humanVeto('opposing_leg_cross_account existing_account=…9908 existing_side=long entry=1.1')).toBe('Opposite leg open on …9908 (long)')
    expect(humanVeto('opposing_leg_cross_account')).toBe('Opposite leg open on another account')
