...
// AccountPanel extracted to ../components/AccountPanel.jsx
...
export default function Agent() {
  ...
  return (
    <section className="space-y-3">
      ...
      {/* cTrader Account — per-account positions, orders, deal history */}
      <PanelFrame id="ctrader-account" title="Trading Account" defaultSize="L"
