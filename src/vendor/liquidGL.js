/* Vendored from https://github.com/naughtyduk/liquidGL (MIT © NaughtyDuk).
 * Loaded lazily by src/lib/liquid-glass.js; requires window.html2canvas.
 */
/* eslint-disable */
/*
    ...
    async captureSnapshot() {
      ...
      const attemptCapture = async (
        ...
        try {
          ...
          /* Patched: guard against NaN/Infinity (zero-sized document on the
             first attempt) — html2canvas-pro rejects non-finite scales. */
          this.scaleFactor = Math.max(0.1, Number.isFinite(scale) ? scale : 1);
