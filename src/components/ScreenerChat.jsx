    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-3 py-2 border-b border-[var(--color-border)]">
          <span className="text-(length:--fs-body) font-semibold">Search stocks/FX by description</span>
        ...
        {err && <div className="px-3 py-1 text-(length:--fs-body) text-[var(--color-warning-text)]">{err}</div>}
